...
namespace ImGui
{
    ...
    IMGUI_API bool          Selectable(const char* label, unsigned int GO_ID, bool selected = false, ImGuiSelectableFlags flags = 0, const ImVec2& size = ImVec2(0, 0)); // THIS IS MY CODE
